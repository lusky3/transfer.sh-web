...
describe('PreviewContainer', () => {
  ...
  it('applies bordered variant styles', () => {
    ...
    expect(container.firstChild).toHaveClass('bg-white', 'dark:bg-gray-900', 'rounded-lg', 'border')
  })

  it('applies custom className', () => {
    const { container } = render(<PreviewContainer className="custom-class">Content</PreviewContainer>)
